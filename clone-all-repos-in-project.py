...
parser.add_argument('-u', '--url', required=True,
    help="The url of your bitbucket server (e.g. https://bitbucket.example.com)")
...
parser.add_argument('-b', '--basedir', required=True,
    help="The basedir where the repositories should be cloned into")
parser.add_argument('--noverify', action='store_true', required=False, 
    help="[optional] Disable SSL verfication by setting this parameter")
...
r = requests.get(url + restApiEndpoint + project + '/repos/?limit=1000000', auth=(username, password), verify=verifyssl)
